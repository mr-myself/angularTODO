...
app.service('todos', ['$rootScope', '$filter', function ($scope, $filter) {
  var list = [];
...
app.controller('RegisterController', ['$scope', 'todos', function ($scope, todos) {
  $scope.newTitle = '';
...
app.controller('ToolbarController', ['$scope', 'todos', function ($scope, todos) {
  ...
  $scope.$on('change:list', function (evt, list) {
    ...
    $scope.remainingCount = list.length - todos.getDone().length;
  });
...
app.controller('TodoListController', ['$scope', 'todos', function ($scope, todos) {
  $scope.$on('change:list', function (evt, list) {
    $scope.todoList = list;
  });
...
app.controller('MainController', ['$scope', function ($scope) {
  $scope.currentFilter = { done: false };
